...
public class CollectionListFragment extends Fragment {
    ...
    private void initComponents(View view) {
        ...
        bgDue = view.findViewById(R.id.due_bottom_bg_collectioList);
        bgSchedule = view.findViewById(R.id.schedule_bottom_bg_collectioList);
        bgCollected = view.findViewById(R.id.collected_bottom_bg_collectioList);
    }
